...
import NavigationBar from 'src/templates/components/Header/components/NavigationBar/NavigationBar';
import LanguageToggleButton from 'src/templates/components/LanguageToggleButton/LanguageToggleButton';
import PolybookLogo from 'src/templates/components/PolybookLogo/PolybookLogo';
import ThemeToggleButton from 'src/templates/components/ThemeToggleButton/ThemeToggleButton';
  ...
  return (
    ...
    >
      ...
      <main className="header-drawer-body">
        <NavigationBar className="header-drawer-body__navigation-bar" onLinkClick={onClose} />
      </main>
