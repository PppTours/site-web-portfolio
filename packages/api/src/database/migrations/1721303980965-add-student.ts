...
export class AddStudent1721303980965 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "study_level" ("id" SERIAL NOT NULL, "name" VARCHAR NOT NULL, CONSTRAINT "PK_3782bca0800b6d4c75f9019eb68" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "student" ADD CONSTRAINT "FK_76b0972b066c01f496c665cfaac" FOREIGN KEY ("specialty_id") REFERENCES "study_specialty"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
